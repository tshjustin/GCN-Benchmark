...
# For GAT 
parser.add_argument("--num_heads", type=int, nargs='+', default=[4,8,16])

# Model Parameters (For both GAT & GCN)
parser.add_argument("--num_layers", type=int, nargs='+', default=[2,3,4])
parser.add_argument("--hidden_dim", type=int, nargs='+', default=[16,32,64])
